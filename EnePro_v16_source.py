...
print("*                                                                             *")
print("*                                                                             *")
#print("*     ====================== Version 1.6 for macOS ======================     *")
#print("*     ====================== Version 1.6 for Linux ======================     *")
#print("*     ================ Version 1.6 for Microsoft Windows ================     *")
print("*     =================== Version 1.6 for Source Code ===================     *")
...
for fileNo in range(len(fileName2), 0, -1):
	if fileName2[fileNo - 1] == '/':
		filePath = fileName2[0:fileNo]
		break
	elif fileName2[fileNo - 1] == '\\':
		filePath = fileName2[0:fileNo]
		break

eneproFile = open(f"{filePath}EnePro_{currentTime}.cdxml", "w")
